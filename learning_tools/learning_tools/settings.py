"""
Django settings for learning_tools project.
...
env_path = BASE_DIR / '.env'  # Ngang hàng với thư mục learning_tools
...
SECRET_KEY = 'django-insecure-q318i(i+#+d&r(c(y_+j_2%3z(1^@b23ptid5%!17ppt*wnhv8'
...
MIDDLEWARE = [
    ...
    'core.middleware.EmailMaskingMiddleware',
]
...
WSGI_APPLICATION = 'learning_tools.wsgi.application'
...
# settings.py - Cập nhật phần static files
