...
urlpatterns = [
    ...
    path('multi-line-analytics/', views.multi_line_analytics_view, name='multi_line_analytics'),
    path('api/multi-line-chart/', views.multi_line_chart_data, name='multi_line_chart_data'),
