...
function clickGroup () {
    // Lấy tất cả các nhóm một lần
    const allGroups = document.querySelectorAll(".todolist_group");
    ...
    allGroups.forEach(item => {
        item.addEventListener("click", function () {
            ...
            // 1. Loại bỏ class 'active' khỏi TẤT CẢ các nhóm
            allGroups.forEach(group => {
                group.classList.remove('active');
            });

            // 2. Thêm class 'active' cho nhóm VỪA ĐƯỢC CLICK (this)
            this.classList.add('active');

            // ===============================================
            // ⚙️ PHẦN XỬ LÝ LOGIC API (GIỮ NGUYÊN)
            // ===============================================
            ...
            if (groupId && groupId.trim() !== "") {
                ...
                console.warn("Không tìm thấy ID nhóm hợp lệ cho phần tử được click.");
